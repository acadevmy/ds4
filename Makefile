...
tests/test_qwen38_ple_store.o: tests/test_qwen38_ple_store.c ds4.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen38_ple_store.c

tests/test_qwen38_ple_store: tests/test_qwen38_ple_store.o $(CORE_OBJS) ds4_gpu_args.o ds4_help.o ds4_kvstore.o rax.o linenoise.o ds4_web.o
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)

.PHONY: test-qwen38-ple-store
test-qwen38-ple-store: tests/test_qwen38_ple_store
	./tests/test_qwen38_ple_store
else
